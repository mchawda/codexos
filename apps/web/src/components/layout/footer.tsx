  ...
  return (
    <footer className="max-w-7xl lg:px-8 mx-auto px-6 pb-12 pt-20">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-1 md:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-6">
              <Code2 className="h-8 w-8 text-foreground mr-3" />
              <span className="text-xl font-semibold tracking-tight text-foreground">CodexOS</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a 
                ...
                className="w-8 h-8 rounded-lg flex items-center justify-center border border-border hover:border-border/60 transition-all duration-300 hover:bg-accent glass-ultra"
                aria-label="Twitter"
              >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border pt-8 mt-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-wrap items-center gap-6 text-xs text-muted-foreground">
            <span>© 2025 CodexOS. All rights reserved.</span>
